...
PREMATCH_TEMPLATE_RADIUS_PREALIGNMENT = 5000
PREMATCH_SCALE_PREALIGNMENT = 0.05
...
#BLOCKMATCH_SCALE_ALIGNMENT = 0.025
...
global PARAMS_MONTAGE = Dict(
			     ...
			     :filter => Dict(
			     		...
			     		:sigma_filter_mid => (2,:get_properties, >, 120, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (3,:get_properties, >, 350, Symbol("xcorr_sigma_0.5")),
...
global PARAMS_PREALIGNMENT = Dict(
			     ...
			     :filter => Dict(
			     		:sigma_filter_high => (1,:get_properties, >, 80, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (2,:get_properties, >, 200, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (3,:get_properties, >, 500, Symbol("xcorr_sigma_0.5"))
			     		# :norm_filter => (:get_norms_std_sigmas, >, 5)
					      ),
			     :render => Dict(
...
#=			     :filter => Dict(
			     		:sigma_filter_high => (:get_properties, >, 6, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (:get_properties, >, 60, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (:get_properties, >, 360, Symbol("xcorr_sigma_0.5")),
			     		:dyn_range_filter => (:get_properties, <, 0.75, :patches_src_normalized_dyn_range),
			     		:r_filter => (:get_properties, <, 0.0275, :xcorr_r_max),
			     		# :norm_filter => (:get_norms_std_sigmas, >, 5),
			     		:kurtosis_filter => (:get_properties, >, 25, :patches_src_kurtosis),
			     		:kurtosis_filter_edge => (:get_properties, <, -1.60, :patches_src_kurtosis),
					:centered_norm_filter => (:get_centered_norms, >, 600)
					      ), =#
			     :filter => Dict(
			     		:sigma_filter_high => (1,:get_properties, >, 6.5, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (2,:get_properties, >, 20, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (3,:get_properties, >, 40, Symbol("xcorr_sigma_0.5")),
			     		#:sigma_filter_high => (1,:get_properties, >, 3.5, Symbol("xcorr_sigma_0.95")),
			     		#:sigma_filter_mid => (2,:get_properties, >, 8, Symbol("xcorr_sigma_0.75")),
			     		#:sigma_filter_low => (3,:get_properties, >, 15, Symbol("xcorr_sigma_0.5")),
			     		:dyn_range_filter => (4,:get_properties, <, 0.50, :patches_src_normalized_dyn_range),
			     		:r_filter => (5,:get_properties, <, 0.0275, :xcorr_r_max),
			     		# :norm_filter => (:get_norms_std_sigmas, >, 5),
			     		:kurtosis_filter => (6,:get_properties, >, 25, :patches_src_kurtosis),
					#for blotches in dst
			     		"kurtosis_filter_dst" => (7,:get_properties, >, 50, "dst_kurtosis"),
			     		:kurtosis_filter_edge => (8,:get_properties, <, -1.60, :patches_src_kurtosis),
...
#=			     :filter => Dict(
			     ...
			     :filter => Dict(
			     #=
			     		:sigma_filter_high => (1,:get_properties, >, 50, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (2,:get_properties, >, 250, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (3,:get_properties, >, 400, Symbol("xcorr_sigma_0.5")),
			     		:kurtosis_filter_edge => (4,:get_properties, <, -1.2, :patches_src_kurtosis),
			     		:kurtosis_filter => (5,:get_properties, >, 25, :patches_src_kurtosis),
			     		:dyn_range_filter => (6,:get_properties, ==, 1.0, :patches_src_normalized_dyn_range),
			     		:dyn_range_filter => (7,:get_properties, <, 0.02, :xcorr_r_max)=#
					      ),
			     :render => Dict(
					      ),
			     :review => Dict(
...
PARAMS_ALIGNMENT_SKIPPED[:filter] = Dict(
			     		:sigma_filter_high => (:get_properties, >, 7, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (:get_properties, >, 100, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (:get_properties, >, 250, Symbol("xcorr_sigma_0.5")),
			     		:r_filter => (:get_properties, <, 0.02, :xcorr_r_max),
			     		# :norm_filter => (:get_norms_std_sigmas, >, 5),
			     		:kurtosis_filter => (:get_properties, >, 25, :patches_src_kurtosis),
			     		:kurtosis_filter_edge => (:get_properties, <, -1.60, :patches_src_kurtosis),
