...
MATCH_SPRING_COEFF_ALIGNMENT = 100.0
...
global PARAMS_MONTAGE = Dict(
			     ...
			     :filter => Dict(
			     		...
			     		:sigma_filter_low => (2,:get_properties, >, 350, Symbol("xcorr_sigma_0.5")),
			     		"r_filter_min" => (2,:get_properties, <, 0.03, :xcorr_r_max),
			     		"r_filter_max" => (2,:get_properties, >, 1, :xcorr_r_max),
...
global PARAMS_PREALIGNMENT = Dict(
			     ...
			     :filter => Dict(
			     		:sigma_filter_high => (2,:get_properties, >, 5, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (2,:get_properties, >, 40, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (2,:get_properties, >, 150, Symbol("xcorr_sigma_0.5"))
			     		# :norm_filter => (:get_norms_std_sigmas, >, 5)
					      ),
			     :render => Dict(
				...
				#=
			     :filter => Dict(
					...
					:centered_norm_filter => (:get_centered_norms, >, 600)
					      ...
					      =#
			     :filter => Dict(
			     		:sigma_filter_high => (1,:get_properties, >, 5, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (2,:get_properties, >, 75, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (3,:get_properties, >, 150, Symbol("xcorr_sigma_0.5")),
			     		:dyn_range_filter => (4,:get_properties, <, 0.45, :patches_src_normalized_dyn_range),
