...
BLOCKMATCH_SCALE_ALIGNMENT = 0.333
BLOCK_R_ALIGNMENT = Int64((224/2)*3)
SEARCH_R_ALIGNMENT = Int64(((512-224)/2)*3)
...
global PARAMS_ALIGNMENT = Dict(
			     ...
			     "match" => Dict(
					...
					# usually (2.5, 12.5) or the like
					"bandpass_sigmas" => (0,0), #sonofalignment
					"depth" => 1,
					"reflexive" => false),
			     "solve" => Dict(
