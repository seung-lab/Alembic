...
global PARAMS_ALIGNMENT = Dict(
			 ...
			 # son of alignment
					"dist" => (0,:get_properties,>,25,:norm),
			     		...
			     		:sigma_filter_mid => (2,:get_properties, >, 14, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (3,:get_properties, >, 20, Symbol("xcorr_sigma_0.5"))
			 #=
			     		:sigma_filter_high => (1,:get_properties, >, 8, Symbol("xcorr_sigma_0.95")),
			     		:sigma_filter_mid => (2,:get_properties, >, 90, Symbol("xcorr_sigma_0.75")),
			     		:sigma_filter_low => (3,:get_properties, >, 200, Symbol("xcorr_sigma_0.5")),
