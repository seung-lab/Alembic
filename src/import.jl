...
# global IMPORT_ROI_BB = BoundingBox(10116, 19884, 33139, 21976) # too small - testing
...
function create_roi_mask(import_table, roi::BoundingBox=IMPORT_ROI_BB, tform=get_tform(overview(1,z_index), OVERVIEW_RESOLUTION))
...
function get_tile_indices(import_table, roi::BoundingBox=IMPORT_ROI_BB, tform=get_tform(overview(1,z_index), OVERVIEW_RESOLUTION))
	all_indices = get_import_indices(import_table)
	roi_mask = create_roi_mask(import_table, roi, tform)
	return all_indices[roi_mask]
end

function update_import_include!(z_index, import_table, roi::BoundingBox=IMPORT_ROI_BB, tform=get_tform(overview(1,z_index), OVERVIEW_RESOLUTION); reset=false)
