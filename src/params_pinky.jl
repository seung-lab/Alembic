...
MESH_LENGTH_PREALIGNMENT = 100
GLOBAL_OFFSETS_PREALIGNMENT = false
BLOCKMATCH_SCALE_PREALIGNMENT = 1
BLOCK_R_PREALIGNMENT = 400
SEARCH_R_PREALIGNMENT = 400
PREMATCH_PREALIGNMENT = true
PREMATCH_TEMPLATE_RATIO_PREALIGNMENT = 0.50
PREMATCH_SCALE_PREALIGNMENT = 1
